...
class Player {
  ...
  strike(player, enemy, attackDmg) {
    ...
    return `${player.name} hits caused ${damageAmount} damages to ${enemy.name}`;
  ...
  heal(player) {
    ...
    return `${player.name} gained a health of ${hpAmount}`;
  }
}
...
let player1 = new Player("Blaq", 100, 10);
let player2 = new Player("Kelvin", 100, 10);
